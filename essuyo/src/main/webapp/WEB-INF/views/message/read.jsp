...
<body>
	...
	<div class="box-body">
		<div class="form-group">
			<label for="exInputTitle"> TITLE </label> 
			<input type="text"	name='title' class="form-control" 
				value="${messageVO.title }"	readonly="readonly">
		</div>
		<div class="form-group">
			<label for="exInputContent"> CONTENT </label>
			<textarea class="form-control" name="content" rows="10" readonly="readonly">
				${messageVO.content }	
			</textarea>
		</div>
		<div class="form-group">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".btn-primary").on("click", function(){
				...
				//formObj.attr("action", "/message/listAll");
			});
