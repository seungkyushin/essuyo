					...
					<div class="col-lg-10 col-xlg-10 col-md-10">
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group">
									<label>[회사 이미지 업로드] </label><br> <span class="help"> ※1. 이미지는 최소 3장, 최대 12장까지 업로드할 수 있습니다. <br> <c:if test="${cvo.id ne 0 || cvo.id ne ''}"> ※2. 새 이미지를 업로드 하시면 기존 이미지들은 삭제됩니다.<br>※3. 선택한 이미지 파일을 취소하시고 싶으실 경우, 다시 파일 선택 버튼을 눌러, 취소 버튼을 누르시면, 이미지 선택을 취소할 수 있습니다.</c:if></span><br>
