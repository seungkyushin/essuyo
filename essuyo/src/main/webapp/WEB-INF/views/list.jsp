...
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="/">ESsuyo</a>
            ...
            <div class="row">
                ...
                <span class="custom-control-description">Pets Friendly</span>
                    ...
                    <div class="row light-bg detail-options-wrap">
                        ...
                        <div class="col-sm-6 col-lg-12 col-xl-6 featured-responsive">
                            <div class="featured-place-wrap">
                                <a href="/detail">
                                    <img src="resources/images/featured4.jpg" class="img-fluid" alt="#">
                                    <span class="featured-rating-green">9.5</span>
                                    <div class="featured-title-box">
                                        <h6>Pizza - Cicis</h6>
                                        <p>Restaurant </p> <span>• </span>
                ...
                <div class="col-md-5 responsive-wrap map-wrap">
                    <div class="map-fix">
                        ...
                        <div id="map" data-lat="37.556537" data-lon="126.945200" data-zoom="14"></div>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?callback=myMap&key=AIzaSyCfXSrmNzLTyVzkWowN6L2a5jQ-TTXigqA"></script>
</body>
