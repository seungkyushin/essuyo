...
INSERT INTO company(name, type,  discription, score, address, number, homepage, state, time, area_list_id ) VALUES("하나 렌트카", "차량대여", "강원도 제일의 렌트카", 0, "강원도 양양군 양양읍 관아길 13-32", "010-5656-2225", "www.rentCar1.com", "영업중", "09:00 ~ 18:00", 4);
INSERT INTO company(name, type,  discription, score, address, number, homepage, state, time, area_list_id ) VALUES("두리 렌트카", "차량대여", "강원도 두번째 렌트카", 0, "강원도 양양군 양양읍 군청길 15", "010-5656-5675", "www.rentCar2.com", "영업중", "09:00 ~ 18:00", 4);
INSERT INTO company(name, type,  discription, score, address, number, homepage, state, time, area_list_id ) VALUES("세니 렌트카", "차량대여", "강원도 셋째가는 렌트카", 0, "강원도 양양군 양양읍 월리 449-1", "010-5656-2323", "www.rentCar3.com", "영업중", "09:00 ~ 18:00", 4);
INSERT INTO company(name, type,  discription, score, address, number, homepage, state, time, area_list_id ) VALUES("네시 렌트카", "차량대여", "강원도 넷째 렌트카", 0, "강원도 양양군 양양읍 동해대로 2996", "010-5656-3467", "www.rentCar4.com", "영업중", "09:00 ~ 18:00", 4);
INSERT INTO company(name, type,  discription, score, address, number, homepage, state, time, area_list_id ) VALUES("다솜 렌트카", "차량대여", "강원도 다섯번째 렌트카", 0, "강원도 양양군 손양면 하왕도리 303", "010-5656-2233", "www.rentCar5.com", "영업중", "09:00 ~ 18:00", 4);
INSERT INTO company(name, type,  discription, score, address, number, homepage, state, time, area_list_id ) VALUES("여솔 렌트카", "차량대여", "강원도 여섯번째 렌트카", 0, "강원도 양양군 손양면 손중로 177", "010-5656-8000", "www.rentCar6.com", "영업중", "09:00 ~ 18:00", 4);
INSERT INTO company(name, type,  discription, score, address, number, homepage, state, time, area_list_id ) VALUES("칠리 렌트카", "차량대여", "강원도 일곱번째 렌트카", 0, "강원도 양양군 손양면 굴개길 72", "010-5656-8676", "www.rentCar7.com", "영업중", "09:00 ~ 18:00", 4);
INSERT INTO company(name, type,  discription, score, address, number, homepage, state, time, area_list_id ) VALUES("팔도 렌트카", "차량대여", "강원도 여덜번째 렌트카", 0, "강원도 양양군 손양면 선사유적로 244", "010-5656-8123", "www.rentCar8.com", "영업중", "09:00 ~ 18:00", 4);
INSERT INTO company(name, type,  discription, score, address, number, homepage, state, time, area_list_id ) VALUES("구구 렌트카", "차량대여", "강원도 아홉번째 렌트카", 0, "강원도 양양군 손양면 굴개길 1-12", "010-5656-8888", "www.rentCar9.com", "영업중", "09:00 ~ 18:00", 4);
INSERT INTO company(name, type,  discription, score, address, number, homepage, state, time, area_list_id ) VALUES("열정 렌트카", "차량대여", "강원도 열번째 렌트카", 0, "강원도 양양군 양양읍 관아길 13-32", "010-5656-8232", "www.rentCar10.com", "영업중", "09:00 ~ 18:00", 4);
INSERT INTO company(name, type,  discription, score, address, number, homepage, state, time, area_list_id ) VALUES("열하 렌트카", "차량대여", "강원도 열한번째 렌트카", 0, "강원도 양양군 손양면 선사유적로 359", "010-5656-8944", "www.rentCar11.com", "영업중", "09:00 ~ 18:00", 4);
INSERT INTO company(name, type,  discription, score, address, number, homepage, state, time, area_list_id ) VALUES("열두 렌트카", "차량대여", "강원도 열두번째 렌트카", 0, "강원도 양양군 서면 떡마을길 85-10", "010-5656-8323", "www.rentCar12.com", "영업중", "09:00 ~ 18:00", 4);
INSERT INTO company(name, type,  discription, score, address, number, homepage, state, time, area_list_id ) VALUES("열세 렌트카", "차량대여", "서울 열세번째 렌트카", 0, "서울특별시 중구 동호로33길 24", "010-5656-7923", "www.rentCar13.com", "영업중", "09:00 ~ 18:00", 1);
INSERT INTO company(name, type,  discription, score, address, number, homepage, state, time, area_list_id ) VALUES("열네 렌트카", "차량대여", "부산 열네번째 렌트카", 0, "부산광역시 연제구 거제대로74번길 71", "010-5656-8323", "www.rentCar14.com", "영업중", "09:00 ~ 18:00", 2);
INSERT INTO company(name, type,  discription, score, address, number, homepage, state, time, area_list_id ) VALUES("열다 렌트카", "차량대여", "광주 열닷번째 렌트카", 0, "광주광역시 서구 월드컵4강로 223", "010-5656-4443", "www.rentCar15.com", "영업중", "09:00 ~ 18:00", 3);
